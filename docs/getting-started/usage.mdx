...
In order to use the [`<Tldraw>`](/gen/tldraw/Tldraw) component, you should also import the `tldraw.css` file from the `@digitalsamba/tldraw` package. You can alternatively import this file inside of another CSS file using the `@import` syntax.
